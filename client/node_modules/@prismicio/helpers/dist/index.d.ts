...
import { DateField, TimestampField, FilledLinkToDocumentField, LinkField, PrismicDocument, RichTextField, ImageFieldImage, TitleField, ImageField, AnyRegularField, Slice, SharedSlice, LinkToMediaField, ColorField, NumberField, KeyTextField, GeoPointField } from '@prismicio/types';
 ...
 */
declare type AsImageSrcReturnType<Field extends ImageFieldImage> = Field extends ImageFieldImage<"empty"> ? null : string;
/**
 ...
 */
declare const asImageSrc: <Field extends _prismicio_types.EmptyImageFieldImage | _prismicio_types.FilledImageFieldImage>(field: Field, params?: ImgixURLParams) => AsImageSrcReturnType<Field>;

/**
 * The return type of `asImageWidthSrcSet()`.
 */
declare type AsImageWidthSrcSetReturnType<Field extends ImageFieldImage> = Field extends ImageFieldImage<"empty"> ? null : {
    /**
 ...
 * @see Imgix URL parameters reference: https://docs.imgix.com/apis/rendering
 */
declare const asImageWidthSrcSet: <Field extends _prismicio_types.EmptyImageFieldImage | _prismicio_types.FilledImageFieldImage>(field: Field, params?: Omit<BuildWidthSrcSetParams, "widths"> & Partial<Pick<BuildWidthSrcSetParams, "widths">>) => AsImageWidthSrcSetReturnType<Field>;

/**
 * The return type of `asImagePixelDensitySrcSet()`.
 */
declare type AsImagePixelDensitySrcSetReturnType<Field extends ImageFieldImage> = Field extends ImageFieldImage<"empty"> ? null : {
    /**
     * The Image field's image URL with Imgix URL parameters (if given).
     */
    src: string;
 ...
 * @see Imgix URL parameters reference: https://docs.imgix.com/apis/rendering
 */
declare const asImagePixelDensitySrcSet: <Field extends _prismicio_types.EmptyImageFieldImage | _prismicio_types.FilledImageFieldImage>(field: Field, params?: Omit<BuildPixelDensitySrcSetParams, "pixelDensities"> & Partial<Pick<BuildPixelDensitySrcSetParams, "pixelDensities">>) => AsImagePixelDensitySrcSetReturnType<Field>;
 ...
 * @returns `true` if `field` is filled, `false` otherwise.
 */
declare const image: <ThumbnailNames extends string | null>(field: ImageField<ThumbnailNames, _prismicio_types.FieldState>) => field is ImageField<ThumbnailNames, "filled">;
/**
